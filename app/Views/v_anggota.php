        ...
        <div class="row g-0">
                ...
                <div class="sidebar">
                    <div>
                        ...
                        <<div class="menu-links">
                            ...
                            <a href="<?= base_url('anggota') ?>" class="menu-item menu-active">👤 Anggota</a>
                            <a href="<?= base_url('peminjaman') ?>" class="menu-item">📖 Peminjaman</a> <a href="#" class="menu-item">📊 Laporan</a>
                        </div>
                    </div>
            ...
            <div class="col-md-9 col-lg-10">
                <div class="main-content">
                    ...
                    <div class="topbar">
                        <input type="text" class="search-box" placeholder="Cari nama atau email anggota...">
                        <?php if (in_array(session()->get('role'), ['Admin', 'Pustakawan'])): ?>
                            <button class="btn-custom">+ Tambah Anggota</button>
                        <?php endif; ?>
                    </div>

                    <div class="section-title-container" style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
                        <h5 class="section-title" style="margin-bottom: 0;">Kelola Data Anggota</h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                    ...
                                                    if ($user['role'] == 'Pustakawan') $badgeColor = 'bg-primary';
                                                    if ($user['role'] == 'Member') $badgeColor = 'bg-success';
                                                ?>
                                                <span class="badge <?= $badgeColor ?>"><?= esc($user['role']) ?></span>
                                            </td>
